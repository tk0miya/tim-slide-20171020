...
* 直近の2年間だとコミットの約60%が @tk0miya によるもの
* ![Image](TODO)
* (もちろん、全部ひとりでやったわけではないです)
...
* Q. なんでメンテナやってるの?
* A. なりゆき。サードパーティの拡張をつくったあとに、大きめの PR を投げたら権限もらえた。
...
* Q. 凄腕だからメンテナなんでしょ?
* A. 違います。コードの構造と業務知識(各種フォーマットとか)を持っているだけです。知識が足りない場合は仕様書とにらめっこです。
  必要な知識が幅広すぎて苦労してます。
...
* Q. 英語ペラペラなんでしょ?
* A. 違います。Google翻訳のおかげです。ただ、2年もやってると、ツールなしで簡単な文章の読み書きぐらいはできるようになります。
  もちろん喋れません。
...
* Q. なんでメンテナやってるの?
* A. 自分では使っていないし、あんまり前向きな理由はないかも。ただ、自分がやめると開発が止まるという責任感めいたものはあるかな。
